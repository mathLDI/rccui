const SeventyPercentBareAndDryUpgradeTo0 = ({
  ...
  const isUpgradeRCCNeeded =
    ...
    ((runwayConditionDescriptionGravel1 === '-Water on top of 100% Compacted Snow' ||
      runwayConditionDescriptionGravel1 === '-Over Ice: Dry Snow, Wet Snow, Slush, Water' ||
      runwayConditionDescriptionGravel1 === '-Ice: -7ºC and warmer OAT' ||
      runwayConditionDescriptionGravel1 === '-Wet Snow greater than 0.13 in depth over Compacted snow/gravel mix' ||
      ...
      runwayConditionDescriptionGravel3 === '-Over Ice: Dry Snow, Wet Snow, Slush, Water' ||
      runwayConditionDescriptionGravel3 === '-Ice: -7ºC and warmer OAT' ||
      runwayConditionDescriptionGravel3 === '-Wet Snow greater than 0.13 in depth over Compacted snow/gravel mix' ||
