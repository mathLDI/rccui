...
const FirstPage = () => {
    ...
    const ButtonTypeOfReportHandler = (v) => {
        console.log("buttonTypeOfReportHandler", v)
        setButtonTypeOfReport(v);
    }

    const dropdownPercentCoverageTopHandler = (v) => {
        console.log("dropdownPercentCoverageTopHandler:", v);
    ...
    const buttonTypeOfReportBool = ({ buttonTypeOfReport }) => {

        if (buttonTypeOfReport === "RCC Not Provided") {
            return true;
        } else {
            return false;
        }
    ...
    const result = buttonTypeOfReportBool({ buttonTypeOfReport: "RCC Not Provided" });
        ...
        <div>
            <div className="grid h-screen md:place-items-center bg-gray-100 justify-center">
                <div className="container mx-auto pt-10 md:pt-0 bg-gray-100">
                    <div>
                        {/****RWYCCC SELECTOR BELOW****/}
                        <Card cardTitle={""} status={null}>
                            <div className="flex flex-row justify-between items-center p-2">
                                <div>Type of Report:</div>
                                <ChoiceListbox
                                    choices={buttonTypeOfReportChoices}
                                    callback={ButtonTypeOfReportHandler} />
                            </div>
                        </Card>
                    </div>
                    {/****RWYCCC SELECTOR ABOVE****/}


                    {/****RWYCCC NOT PROVIDED CARD BELOW****/}

                    {buttonTypeOfReportBool({ buttonTypeOfReport }) === true &&
                        <div>
                ...
                <div>
                    <div className="grid h-screen md:place-items-center bg-gray-100 justify-center" >
                        <div className="container mx-auto pt-10 md:pt-0 bg-gray-100"   >
                            ...
                            <Card cardTitle={"RCC Provided"} status={null}>
                                <div>
                                    <div className="flex flex-row justify-between p-2">
                                        <div>RCC code:</div>
